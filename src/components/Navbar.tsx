...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`fixed left-0 top-0 z-40 flex h-screen w-full transform flex-col items-center justify-center gap-8 bg-sky-800 text-2xl text-white transition-all duration-500 ${
